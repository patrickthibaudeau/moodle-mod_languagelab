...
function addEventsToStudentElem(elem)
{
    ...
    $('.menuStudent',elem).click(function(e){e.stopPropagation();});
    
    $('.talkToStudent', elem).click(function(){
        
        $("#dialogInfo").html(textLoadingConnectClient);
        $("#dialogInfo").dialog({modal: true,buttons: [], open: function(event, ui){$(".ui-dialog-titlebar-close", $(this).parent()).hide();}});
