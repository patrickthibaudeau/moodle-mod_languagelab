...
$l  = optional_param('l', 0, PARAM_INT);  // languagelab instance ID - it should be named as the first character of the module
...
echo $OUTPUT->box_start();
	...
	echo '</object>'."\n";
    	...
    	//print out flash applet
    	echo '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="600" height="180" id="SimpleRecorderGB2" align="middle">'."\n";
	echo '<param name="allowScriptAccess" value="sameDomain" />'."\n";
	echo '<param name="allowFullScreen" value="false" />'."\n";
	echo '<param name="wmode" value="transparent"> '."\n";
	echo '<param name="movie" value="LanguageLabCT.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="xmlAddress=student.param.xml.php?id='.$id.'"/>	<embed src="LanguageLabCT.swf" wmode="transparent" flashvars="xmlAddress=student.param.xml.php?id='.$id.'" quality="high" bgcolor="#ffffff" width="600" height="180" name="StudentConsole" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" />'."\n";
	echo '</object>'."\n";
